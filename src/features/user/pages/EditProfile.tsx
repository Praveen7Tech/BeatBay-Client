...
export default function EditProfile() {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-[#1a1a1a] rounded-lg border border-[#2a2a2a] p-8">
      ...
      <form onClick={handleSubmit(EditProfileData)}>
      ...
      <div className="mb-8 pb-8 border-b border-[#2a2a2a]">
        ...
        <div className="flex items-center gap-6">
          <div className="w-24 h-24 bg-[#2a2a2a] rounded-full flex items-center justify-center border-2 border-[#3a3a3a]">
            <User className="w-12 h-12 text-gray-500" />
          </div>
          <button className="flex items-center gap-2 px-4 py-2 bg-[#00d084] text-black rounded-lg font-medium hover:bg-[#00c070] transition-colors">
      ...
      <div className="flex gap-3 mt-8 pt-8 border-t border-[#2a2a2a]">
        ...
        <button className="flex-1 px-4 py-3 bg-[#2a2a2a] text-gray-300 rounded-lg font-semibold hover:bg-[#3a3a3a] transition-colors">
          Cancel
        </button>
      </div>
      </form>
