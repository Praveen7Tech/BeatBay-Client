      ...
      <table className="w-full">
        <thead>
          <tr className="border-b border-[#282828]">
            ...
            <th className="text-left px-4 py-3 text-spotify-secondary text-sm font-medium hidden md:table-cell">Album</th>
            <th className="text-left px-4 py-3 text-spotify-secondary text-sm font-medium hidden lg:table-cell">Date added</th>
          ...
          {songs.map((song, index) => (
            ...
            >
              ...
              <td className="px-4 py-4 hidden lg:table-cell">
                <span className="text-spotify-secondary text-sm">{"song.dateAdded"}</span>
              </td>
