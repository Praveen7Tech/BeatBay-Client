...
export default function RightPanel({ onProfileClick }: { onProfileClick?: () => void }) {
  return (
    <div className="w-80 bg-[#1a1a1a] border-l border-[#2a2a2a] flex flex-col overflow-hidden hidden xl:flex">
