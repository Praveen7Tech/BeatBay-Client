...
export default function ArtistCard() {
  return (
    <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] rounded-2xl p-8 flex items-center gap-8 border border-[#2a2a2a]">
      {/* Left Content */}
      ...
      <div className="hidden lg:block flex-shrink-0">
        <div className="w-64 h-64 bg-gradient-to-br from-[#00d084] to-[#0f0f0f] rounded-2xl overflow-hidden">
