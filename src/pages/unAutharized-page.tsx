      ...
      <div className="text-center max-w-md">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative w-24 h-24">
            <div className="absolute inset-0 bg-linear-to-r from-green-500 to-green-600 rounded-full opacity-20 animate-pulse" />
        ...
        {/* Heading */}
        <h1 className="text-5xl font-bold mb-2 bg-linear-to-r from-green-400 to-green-600 bg-clip-text text-transparent">
          401
        </h1>
